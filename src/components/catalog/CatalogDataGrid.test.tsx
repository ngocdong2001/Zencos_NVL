...
const mockMaterials = [
  { id: '1', code: 'NVL-001', internalName: '', inciName: 'Glycerin', materialName: 'Glycerin 99.5%', category: 'raw_material', unit: 'KG', orderUnit: 'KG', minStockLevel: 0, status: 'Active' },
  { id: '2', code: 'NVL-002', internalName: '', inciName: 'Water', materialName: 'Distilled Water', category: 'raw_material', unit: 'L', orderUnit: 'L', minStockLevel: 0, status: 'Active' },
]
